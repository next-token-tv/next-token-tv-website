...
- `src/content/data/people/*.yaml` is the person metadata authority. Hosts and people discussed in episodes share this collection and `/wiki/people/{id}` routes; host memberships determine the co-host role.
- `/wiki/people` and `/en/wiki/people` list all people. Existing co-host profiles retain their presentation. Other profiles show biographies, source links and related episode chapters.
