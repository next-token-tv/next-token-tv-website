...
- Brand, product and person pages with articles use `WikiDetailHeader.astro` for the return navigation, hero grid, title, summary and expandable aliases. `WikiIdentityCard.astro` owns the visual card.
