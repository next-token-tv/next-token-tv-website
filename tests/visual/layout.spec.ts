...
const routes = [
  ...
  { path: "/wiki", shell: ".wiki-home-hero.shell", visual: ".wiki-home-hero" },
  { path: "/en/wiki", shell: ".wiki-home-hero.shell", visual: ".wiki-home-hero" },
  ...
  { path: "/wiki/people", shell: ".entity-index-hero.shell", visual: ".entity-index-hero" },
  { path: "/en/wiki/people", shell: ".entity-index-hero.shell", visual: ".entity-index-hero" },
