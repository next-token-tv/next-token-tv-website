...
- Developer platforms: the Chinese [BigModel platform](https://bigmodel.cn/) provides model APIs and fine-tuning; international API usage and model lists are documented at [Z.AI API Docs](https://docs.z.ai/), which also describes a monthly GLM Coding Plan subscription.
- Agent products: [ZCode](/en/wiki/products/zcode) is an agentic development environment for planning, coding, and debugging; [AutoGLM](/en/wiki/products/autoglm) targets device interaction and task execution.
- Open source: the official GitHub organization [zai-org](https://github.com/zai-org) maintains open-source GLM releases as well as projects such as CodeGeeX, CogView, and CogVideoX.

Model versions, capabilities, and prices change; read the current official pages before relying on any of them.
...
The GLM Coding Plan is a monthly subscription for coding use cases. The [official quick start documentation](https://docs.z.ai/) describes it as compatible with coding tools such as Claude Code and Cline when calling GLM models. Plan contents and prices should be read from the official pages.
...
- [zai-org (GitHub)](https://github.com/zai-org)
- [Zhipu AI - Wikipedia](https://en.wikipedia.org/wiki/Zhipu_AI)
