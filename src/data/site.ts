...
const siteContentBase: Record<Locale, SiteContentBase> = {
  "zh-Hans": {
    ...
    hero: {
      ...
      headingLead: "不只预测\n下一个",
      headingAccent: "词元。",
      intro: "一档从中文世界一手经验出发，讨论 AI 技术、产品、创业与创作的视频播客。",
  ...
  en: {
    ...
    hero: {
      ...
      headingAccent: "token.",
      intro: "A video podcast drawing on first-hand experience from the Chinese-speaking world to discuss AI technology, products, entrepreneurship, and creativity.",
